...
By combining SQL-based insights with an interactive Power BI dashboard, the analysis provides a complete view of business performance and growth opportunities.
...
* Nearly **90% of orders** are high-value (₹500+), reflecting healthy spending habits.
* **Fresh Garden** leads in total revenue, while some outlets need improvement.
* **Non-Metro cities** contribute around 80% of total orders, showing untapped regional potential.
* **Mumbai** records the highest average order value, followed by Hyderabad and Pune.
...
* **PowerPoint** – Business report and presentation summary
...
* High vs low value order analysis
* Regional revenue contribution

These visuals help in making **data-driven business decisions** to improve efficiency and growth.
